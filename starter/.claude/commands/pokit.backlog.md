...
Use `pokit issue:create` for issue creation receipts and `pokit issues` to confirm the available IDs. Active issue selection is managed by the agent workflow.
