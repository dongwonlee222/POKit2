...
The agent workflow blocks switching away from a non-gate_passed active issue. Do not describe `pokit.next` as a bypass; it only transitions after gate evidence exists.
