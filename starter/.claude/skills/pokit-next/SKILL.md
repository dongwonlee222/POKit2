...
<!-- Seed maintained in the pokit2 package (starter/). Refreshed by `pokit update`; do not edit by hand. -->
...
- The engine blocks switching away from a non-gate_passed active issue, so transition wording must not imply bypassing the guard.
